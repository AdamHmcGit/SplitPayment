  ...
  a.widget("ui.dropdownchecklist", {
    ...
    _handleKeyboard: function(d) {
      ...
      if (!b.dropWrapper.isOpen && b._isDropDownKeyShortcut(d, c)) {
        ...
        if (b.dropWrapper.isOpen && b._isDropDownCloseKey(d, c)) {
          ...
          if (b.dropWrapper.isOpen && (d.target.type == "checkbox") &&
            ((c == a.ui.keyCode.DOWN) || (c == a.ui.keyCode.UP))) {
            d.stopImmediatePropagation();
            b._keyFocusChange(d.target, (c == a.ui.keyCode.DOWN) ? 1 :
              -1, true)
          } else {
      ...
      if (b && !c.dropWrapper.isOpen) {
        ...
        if (d) {
          ...
          if (a.ui.dropdownchecklist.gLastOpened != null) {
            a.ui.dropdownchecklist.gLastOpened._toggleDropContainer(
              false)
          }
        } else {
    ...
    _appendControl: function() {
      ...
      if (k.icon != null) {
        ...
        var g = a("<div/>");
        g.addClass("ui-icon");
        g.addClass((k.icon.toOpen != null) ? k.icon.toOpen :
    ...
    _createDropItem: function(g, f, o, l, q, h, e, k) {
      ...
      var s;
      if (m.isMultiple) {
        s = a('<input disabled type="checkbox" id="' + n + '"' + r + j +
          ' tabindex="' + f + '" />')
      } else {
        s = a('<input disabled type="radio" id="' + n + '" name="' + b +
          '"' + r + j + ' tabindex="' + f + '" />')
      }
    ...
    _toggleDropContainer: function(e) {
      ...
      var d = function(f) {
        if ((f != null) && f.dropWrapper.isOpen) {
          ...
          if (j.length > 0) {
            j.removeClass((h.icon.toClose != null) ? h.icon.toClose :
              "ui-icon-triangle-1-s");
            j.addClass((h.icon.toOpen != null) ? h.icon.toOpen :
              "ui-icon-triangle-1-e")
          }
      ...
      var b = function(n) {
        if (!n.dropWrapper.isOpen) {
          ...
          if ((g.positionHow == null) || (g.positionHow == "absolute")) {
            n.dropWrapper.css({
              position: "absolute",
              top: n.controlWrapper.position().top + n.controlWrapper
                .outerHeight() + "px",
          ...
          if (h.length > 0) {
            h.removeClass((g.icon.toOpen != null) ? g.icon.toOpen :
              "ui-icon-triangle-1-e");
            h.addClass((g.icon.toClose != null) ? g.icon.toClose :
              "ui-icon-triangle-1-s")
          }
